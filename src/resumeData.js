let resumeData = {
    ...
    "aboutme": "안녕하세요. 데브옵스 엔지니어 유재균입니다.\n" +
        ...
        "최근에는 k9s를 학습하고 있으며 Grafana, Prometheus, Promtail, Loki를 이용하여 클러스터에 포함되어 있는 리소스의 메트릭과 어플리케이션 로그를 모니터링하는 시스템을 구축하여 운영해본 경험이 있습니다.\n" +
        "현재는 추천시스템을 개발하여 흩뿌려져 있는 다양한 공공정책들 중 사용자가 신청가능한 정책들만 모아 알림을 주는 프로젝트 개발중에 있습니다.\n" + 
